<template>
  <div class="box-login">
    ...
    <Input label="E-mail" placeHolder="exemplo@gmail.com" v-model="usuario.email"/>
    <Input label="Senha" placeHolder="123456" type="password" v-model="usuario.senha"/>
    <Button value="Entrar" :callback="login" />
  </div>
</template>
